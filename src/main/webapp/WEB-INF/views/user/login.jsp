...
<form action="/loginProc" method="post" id="loginForm" name="loginForm" class="modal-content">
	<h1 id="logo-h1"><a href="/">MediaTalk</a></h1>
	<h3 id="font-h3">로그인</h3>
	...
	<div id="info">
		<span>계정이 없으신가요? <a id="joinTag" href="/register.go">회원가입</a></span>
		<hr>
	</div>
